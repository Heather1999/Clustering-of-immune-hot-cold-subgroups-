...
csv_dir=r"C:\Users\Heather P\Desktop\github\T1\GSE107943_109.csv"
...
cell_pop=gene_file.loc[:,['Cell population','ENSEMBL ID']]
#1.Tcell_Entrezid
Tcells_id=[]
...
rows_to_drop = range(30, 300)  # +1 to include the end_index
